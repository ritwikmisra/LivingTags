...
typedef NS_ENUM(NSUInteger, WEB_SERVICES) {
    ...
    WEB_SERVICE_PRODUCT_LISTING,
    WEB_SERVICE_PRODUCT_DETAILS,
    WEB_SERVICE_DELETE_VOICE,
    WEB_SERVICE_VIEW_LOCAL_TAGS,
    WEB_SERVICE_COMMENT_LISTING,
    WEB_SERVICE_GET_OBITUARIES,
    WEB_SERVICE_UPDATE_OBITUARIES,
    WEB_SERVICE_COMMENT_DETAILS,
    WEB_SERVICE_DELETE_COMMENT,
    WEB_SERVICE_DELETE_TAGS
};
